...
In \Cref{existence}, we studied the existence result \cite{ber81} for ground
state solutions to the equation
\be\label{updeber}
\Delta u - u = f(u)\quad\text{in }\R^3,
\ee
where $f(u)$ satisfies the general conditions described in \Cref{fass}.
Motivated by \Cref{physics}, we are interested in the specific case 
...
%\eqref{upde} is the case where $k=3$.
